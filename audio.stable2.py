...
# Now accepts socketio instance to emit directly
def run_transcription(processing_queue,socketio_instance):
...
def process_transcripts(processing_queue,socketio_instance):
...
def diarization_correction_thread(processing_queue,socketio_instance):
...
if __name__ == "__main__":
    ...
    transcription_thread = threading.Thread(target=run_transcription, args=(processing_queue,dummy_socketio), daemon=True)
    processing_thread = threading.Thread(target=process_transcripts, args=(processing_queue,dummy_socketio), daemon=True) # Pass socketio here
    diarization_thread = threading.Thread(target=diarization_correction_thread, args=(processing_queue,dummy_socketio), daemon=True) # Pass socketio here
